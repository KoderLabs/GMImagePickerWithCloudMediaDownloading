#
#  Be sure to run `pod spec lint GMImagePickerWithCloudMediaDownloading.podspec' to ensure this is a
...
Please check the https://github.com/guillermomuntaner/GMImagePicker for integration."
  ...
  spec.description  = "Its an image picker based on GMImagepicker with support of downloading media from cloud like whatsapp imagepicker. It downloads the device gallery's images and videos from cloud for further use. UI elements have been added like indicator for downloading. Media item gets selected automatically once downloading is done.
Please check the https://github.com/guillermomuntaner/GMImagePicker for integration."

  spec.homepage     = "https://github.com/MubeenQazi/GMImagePickerWithCloudMediaDownloading"
  ...
  spec.author             = { "Mubeen Raza Qazi" => "https://www.linkedin.com/in/ios-dev-mubeen-raza/" }
  # Or just: spec.author    = "Mubeen Raza Qazi"
  # spec.authors            = { "Mubeen Raza Qazi" => "" }
  # spec.social_media_url   = "https://twitter.com/Mubeen Raza Qazi"
  ...
  spec.source       = { :git => "https://github.com/MubeenQazi/GMImagePickerWithCloudMediaDownloading.git", :tag => "#{spec.version}" }
